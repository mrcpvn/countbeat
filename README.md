...
```
git remote set-url origin https://github.com/mrcpvn/countbeat
...
To generate etc/countbeat.template.json and etc/countbeat.asciidoc
...
```
mkdir -p ${GOPATH}/github.com/mrcpvn
cd ${GOPATH}/github.com/mrcpvn
git clone https://github.com/mrcpvn/countbeat
```
